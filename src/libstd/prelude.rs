...
#[cfg(not(feature = "rustos"))]  #[doc(no_inline)] pub use c_str::ToCStr;
...
#[cfg(not(feature = "rustos"))] #[doc(no_inline)] pub use path::{GenericPath, Path, PosixPath, WindowsPath};
...
#[cfg(not(feature = "rustos"))]  #[doc(no_inline)] pub use comm::{sync_channel, channel};
#[cfg(not(feature = "rustos"))]  #[doc(no_inline)] pub use comm::{SyncSender, Sender, Receiver};
#[cfg(not(feature = "rustos"))]  #[doc(no_inline)] pub use task::spawn;
