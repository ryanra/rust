...
#[cfg(not(feature = "rustos"))] pub use rand::os::OsRng;
...
#[cfg(not(feature = "rustos"))] struct TaskRngReseeder;
...
#[cfg(not(feature = "rustos"))] type TaskRngInner = reseeding::ReseedingRng<StdRng, TaskRngReseeder>;
